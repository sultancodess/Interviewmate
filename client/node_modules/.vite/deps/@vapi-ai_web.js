...
function L(e2, t2) {
  ...
  if (e2 && t2 && (n2 = e2.constructor) === t2.constructor) {
    ...
    if (!n2 || "object" == typeof e2) {
      for (n2 in r2 = 0, e2) {
        if (D.call(e2, n2) && ++r2 && !D.call(t2, n2))
          return false;
        if (!(n2 in t2) || !L(e2[n2], t2[n2]))
          return false;
      }
...
function Ie(e2) {
  ...
  if (t2 && function(e3) {
    ...
    return !(["protocol", "publicKey", "host", "projectId"].find((t4) => !e3[t4] && (Ae.error(`Invalid Sentry Dsn: ${t4} missing`), true)) || (n2.match(/^\d+$/) ? function(e4) {
...
function wt(e2, t2, n2 = 1 / 0, r2 = 1 / 0, i2 = function() {
...
function bn(e2, t2, n2 = Tt(e2.bufferSize || _n)) {
  ...
  function i2(i3) {
    ...
    return n2.add(() => t2({ body: Bt(a2, e2.textEncoder) }).then((e3) => (void 0 !== e3.statusCode && (e3.statusCode < 200 || e3.statusCode >= 300) && ("undefined" == typeof __SENTRY_DEBUG__ || __SENTRY_DEBUG__) && Ae.warn(`Sentry responded with status code ${e3.statusCode} to sent event.`), r2 = Yt(r2, e3), e3), (e3) => {
      ...
      if (e3 instanceof Le)
        return ("undefined" == typeof __SENTRY_DEBUG__ || __SENTRY_DEBUG__) && Ae.error("Skipped sending event because buffer is full."), s2("queue_overflow"), kt();
      throw e3;
    });
  }
...
function ms(e2) {
  ...
  if (e2)
    for (var t2 = 0, r2 = Object.entries(e2); t2 < r2.length; t2++)
      for (var i2 = g(r2[t2], 1)[0], o2 = 0, a2 = Object.entries(e2[i2]); o2 < a2.length; o2++) {
...
var init_daily_esm = __esm({
  "node_modules/@daily-co/daily-js/dist/daily-esm.js"() {
    ...
    be = "object" == typeof globalThis && _e(globalThis) || "object" == typeof window && _e(window) || "object" == typeof self && _e(self) || "object" == typeof global && _e(global) || function() {
      return this;
    }() || {};
    ke = we();
    Ee = 80;
    ...
    mn = class _mn {
      ...
      captureException(e2, t2, n2) {
        if (yt(e2))
          return void (("undefined" == typeof __SENTRY_DEBUG__ || __SENTRY_DEBUG__) && Ae.log(gn));
      ...
      sendEvent(e2, t2 = {}) {
        if (this._dsn) {
          ...
          for (const e3 of t2.attachments || [])
            n2 = Nt(n2, Ut(e3, this._options.transportOptions && this._options.transportOptions.textEncoder));
      ...
      _processEvent(e2, t2, n2) {
        ...
        if (!this._isEnabled())
          return Et(new Le("SDK not enabled, will not capture event.", "log"));
        const o2 = yn(e2), a2 = vn(e2), s2 = e2.type || "error", c2 = `before send for type \`${s2}\``;
        if (a2 && "number" == typeof i2 && Math.random() > i2)
          return this.recordDroppedEvent("sample_rate", "error", e2), Et(new Le(`Discarding event because it's not included in the random sample (sampling rate = ${i2})`, "log"));
        const l2 = "replay_event" === s2 ? "replay" : s2;
        return this._prepareEvent(e2, t2, n2).then((n3) => {
          if (null === n3)
            throw this.recordDroppedEvent("event_processor", l2, e2), new Le("An event processor returned `null`, will not send event.", "log");
          ...
          if (null === r3)
            throw this.recordDroppedEvent("before_send", l2, e2), new Le(`${c2} returned \`null\`, will not send event.`, "log");
            ...
            if (t3) {
              ...
              return function(e4, t4) {
                if (t4.ignoreInternal && function(e5) {
                  ...
                  return ("undefined" == typeof __SENTRY_DEBUG__ || __SENTRY_DEBUG__) && Ae.warn(`Event dropped due to being internal Sentry Error.
Event: ${gt(e4)}`), true;
                if (function(e5, t5) {
                  ...
                  return ("undefined" == typeof __SENTRY_DEBUG__ || __SENTRY_DEBUG__) && Ae.warn(`Event dropped due to being matched by \`ignoreErrors\` option.
Event: ${gt(e4)}`), true;
                if (function(e5, t5) {
                  ...
                  return ("undefined" == typeof __SENTRY_DEBUG__ || __SENTRY_DEBUG__) && Ae.warn(`Event dropped due to being matched by \`ignoreTransactions\` option.
Event: ${gt(e4)}`), true;
                if (function(e5, t5) {
                  if (!t5 || !t5.length)
                    return false;
                  ...
                  return ("undefined" == typeof __SENTRY_DEBUG__ || __SENTRY_DEBUG__) && Ae.warn(`Event dropped due to being matched by \`denyUrls\` option.
Event: ${gt(e4)}.
Url: ${On(e4)}`), true;
                if (!function(e5, t5) {
                  if (!t5 || !t5.length)
                  ...
                  return ("undefined" == typeof __SENTRY_DEBUG__ || __SENTRY_DEBUG__) && Ae.warn(`Event dropped due to not being matched by \`allowUrls\` option.
Event: ${gt(e4)}.
Url: ${On(e4)}`), true;
                return false;
              }(e3, o2) ? null : e3;
    ...
    qn = class _qn {
      ...
      setupOnce() {
        this.options.console && nt("console", Yn), this.options.dom && nt("dom", function(e2) {
          function t2(t3) {
    ...
    Hn = class extends mn {
      ...
      captureUserFeedback(e2) {
        if (!this._isEnabled())
          return void (("undefined" == typeof __SENTRY_DEBUG__ || __SENTRY_DEBUG__) && Ae.warn("SDK not enabled, will not capture user feedback."));
        const t2 = function(e3, { metadata: t3, tunnel: n2, dsn: r2 }) {
          const i2 = { event_id: e3.event_id, sent_at: (/* @__PURE__ */ new Date()).toISOString(), ...t3 && t3.sdk && { sdk: { name: t3.sdk.name, version: t3.sdk.version } }, ...!!n2 && !!r2 && { dsn: je(r2) } }, o2 = function(e4) {
      ...
      _flushOutcomes() {
        ...
        if (0 === e2.length)
          return void (("undefined" == typeof __SENTRY_DEBUG__ || __SENTRY_DEBUG__) && Ae.log("No outcomes to send"));
        if (!this._dsn)
          return void (("undefined" == typeof __SENTRY_DEBUG__ || __SENTRY_DEBUG__) && Ae.log("No dsn provided, will not send outcomes"));
          ...
          if (n3) {
            try {
              if (function(e4, t3) {
                ...
                return ("undefined" == typeof __SENTRY_DEBUG__ || __SENTRY_DEBUG__) && Ae.warn("Event dropped due to being a duplicate of previously captured event."), null;
            } catch (t3) {
    ...
    Ho = function() {
      ...
      return o(e2, [{ key: "isNoOp", value: function() {
        ...
        if (!Wo.includes(e3))
          throw Error("Unrecognized mergeStrategy provided. Options are: [".concat(Wo, "]"));
        ...
        if (r2.length > co)
          throw Error("Meeting session data is too large (".concat(r2.length, " characters). Maximum size suppported is ").concat(co, "."));
      } }]), e2;
    }();
    ea = function() {
      function e2(n2) {
      ...
      return o(e2, [{ key: "load", value: function() {
        ...
        if (this.loaded)
          return window._daily.instances[this._callFrameId].callMachine.reset(), void r2(true);
    ...
    Xa = function(r2) {
      ...
      function Z2(e2) {
        ...
        if (t(this, Z2), d(a(n2 = Q2.call(this)), "startListeningForDeviceChanges", function() {
          ...
          var e3 = p(function* (e4) {
            if ("destroyed" === e4)
              return console.warn("App has been destroyed before leaving the meeting. Cleaning up all the resources!"), void (yield n2.destroy());
            var t2 = "active" === e4;
          ...
          if (n2._logDuplicateInstanceAttempt(), n2.strictMode)
      ...
      return o(Z2, [{ key: "destroy", value: (z2 = p(function* () {
        ...
        for (var n2 in t2) {
          ...
          if (Ka[n2].validate && !Ka[n2].validate(t2[n2], this, this._participants[e2]))
            throw new Error(Ka[n2].help);
        }
        ...
        if (os(this._callObjectMode, "updateWaitingParticipant()"), es(this._callState, "updateWaitingParticipant()"), "string" != typeof t2 || "object" !== n(r3))
        ...
        if (os(this._callObjectMode, "updateWaitingParticipants()"), es(this._callState, "updateWaitingParticipants()"), "object" !== n(t2))
        ...
        if (os(this._callObjectMode, "getReceiveSettings()"), !this._callMachineInitialized)
        ...
        var t2 = this;
        if (os(this._callObjectMode, "updateReceiveSettings()"), !us(e2, { allowAllParticipantsKey: true }))
          throw new Error(fs({ allowAllParticipantsKey: true }));
        ...
        if (ss(), this._callMachineInitialized)
        ...
        var t2 = this;
        if ("undefined" == typeof AudioWorkletNode && !ko())
        ...
        var e2 = this, t2 = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {};
        if (os(this._callObjectMode, "startCamera()"), ns(this._callState, this._isPreparingToJoin, "startCamera()", "Did you mean to use setLocalAudio() and/or setLocalVideo() instead?"), is(this._testCallInProgress, "startCamera()"), this.needsLoad())
          try {
            yield this.load(t2);
          } catch (e3) {
        ...
        if (cs(), [Ua, Va].includes(e2)) {
          if (e2 !== this._nativeInCallAudioMode)
            return this._nativeInCallAudioMode = e2, !this.disableReactNativeAutoDeviceManagement("audio") && ts(this._callState, this._isPreparingToJoin) && this.nativeUtils().setAudioMode(this._nativeInCallAudioMode), this;
        } else
          console.error("invalid in-call audio mode specified: ", e2);
      } }, { key: "preAuth", value: (j2 = p(function* () {
        var e2 = this, t2 = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {};
        if (os(this._callObjectMode, "preAuth()"), ns(this._callState, this._isPreparingToJoin, "preAuth()"), is(this._testCallInProgress, "preAuth()"), this.needsLoad() && (yield this.load(t2)), !t2.url)
        ...
        return is(this._testCallInProgress, "leave()"), new Promise(function(t2) {
          if (e2._callState === Mr || e2._callState === Tr)
            ...
            e2._resolveLeave = t2, e2.sendMessageToCallMachine({ action: "leave-meeting" });
        });
      }), function() {
        ...
        if (rs(this._callMachineInitialized, "startScreenShare()"), t2.screenVideoSendSettings && this._validateVideoSendSettings("screenVideo", t2.screenVideoSendSettings), t2.mediaStream && (this._sharedTracks.screenMediaStream = t2.mediaStream, t2.mediaStream = fo), "undefined" != typeof DailyNativeUtils && void 0 !== DailyNativeUtils.isIOS && DailyNativeUtils.isIOS) {
          ...
          if (yield n2.isScreenBeingCaptured())
            return void this.emit(ao, { action: ao, type: "screen-share-error", errorMsg: "Could not start the screen sharing. The screen is already been captured!" });
          ...
          this.sendMessageToCallMachine({ action: uo, captureOptions: t2 });
      }), function() {
          ...
          for (var r3 = 0; r3 < e2.length; r3++) {
            ...
            for (var o2 in this._validateEncodingLayerHasValidProperties(i3), i3)
              if (Ya.includes(o2)) {
                ...
                throw new Error("Invalid key ".concat(o2, ", valid keys are:") + Object.values(Ya));
        ...
        try {
          !function(e3) {
            ...
            for (var t3 in e3)
              if (!Ja.includes(t3))
                throw new Error("Invalid key ".concat(t3, ", valid keys are: ").concat(Ja));
        ...
        var e2 = this;
        if (is(this._testCallInProgress, "testWebsocketConnectivity()"), this.needsLoad())
          try {
            yield this.load();
          } catch (e3) {
            return Promise.reject(e3);
        ...
        }(this._callMachineInitialized, "testCallQuality()"), t2.videoTrack && !this._validateVideoTrackForNetworkTests(t2.videoTrack))
        ...
        if (this._sharedTracks.videoTrackForConnectionQualityTest = o2, this.needsLoad())
          try {
        ...
        var t2 = this;
        if (is(this._testCallInProgress, "testConnectionQuality()"), this.needsLoad())
          try {
            yield this.load();
          } catch (e3) {
            return Promise.reject(e3);
        ...
        var t2 = this;
        if (is(this._testCallInProgress, "testNetworkConnectivity()"), this.needsLoad())
          try {
            yield this.load();
          } catch (e3) {
            return Promise.reject(e3);
        ...
        var t2 = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : "*";
        if (es(this._callState, "sendAppMessage()"), JSON.stringify(e2).length > 4096)
        ...
        if (ss(), this._iframe && !document.fullscreenElement && To())
          try {
        ...
        if (ss(), "number" != typeof e2 && true !== e2 && false !== e2)
        ...
        for (var t2 in e2) {
          if (!Qa[t2])
            throw new Error("unrecognized property '".concat(t2, "'"));
          if (Qa[t2].validate && !Qa[t2].validate(e2[t2], this))
            throw new Error("property '".concat(t2, "': ").concat(Qa[t2].help));
        }
        ...
        switch (t2.action) {
          ...
          case oo:
            if (!L(this._inputSettings, t2.inputSettings)) {
              ...
              if (this._inputSettings = t2.inputSettings, this._preloadCache.inputSettings = {}, !L(g2, this._getInputSettings()))
                try {
        ...
        var n2 = "record";
        if (e2 && !t2.local && false === t2[n2] && e2[n2] !== t2[n2])
          try {
        ...
        var n2 = "record";
        if (e2 && !t2.local && true === t2[n2] && e2[n2] !== t2[n2])
          try {
        ...
        if (e2 && ("ended" === e2.readyState || !t2 || e2.id !== t2.id))
          try {
        ...
        if (t2 && (!e2 || "ended" === e2.readyState || t2.id !== e2.id))
          try {
        ...
        if (e2)
          for (var n2 in e2.tracks)
            this.maybeEventTrackStopped(e2.tracks[n2].track, t2 && t2.tracks[n2] ? t2.tracks[n2].track : null, t2, n2);
      } }, { key: "maybeParticipantTracksStarted", value: function(e2, t2) {
        if (t2)
          for (var n2 in t2.tracks)
            this.maybeEventTrackStarted(e2 && e2.tracks[n2] ? e2.tracks[n2].track : null, t2.tracks[n2].track, t2, n2);
        ...
        var t2 = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
        if (ss(), !e2 || !e2.contentWindow || "string" != typeof e2.src)
